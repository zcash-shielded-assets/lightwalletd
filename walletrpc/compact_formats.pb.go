...
type CompactTx struct {
	...
	Issuances     []*CompactIssuance `protobuf:"bytes,10,rep,name=issuances,proto3" json:"issuances,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_compact_formats_proto_rawDesc = "" +
	...
	"\rchainMetadata\x18\b \x01(\v2$.cash.z.wallet.sdk.rpc.ChainMetadataR\rchainMetadata\"\xcd\x03\n" +
	"\tCompactTx\x12\x14\n" +
	...
	"\tissuances\x18\n" +
	" \x03(\v2&.cash.z.wallet.sdk.rpc.CompactIssuanceR\tissuancesJ\x04\b\t\x10\n" +
	"\"S\n" +
	"\vCompactTxIn\x12 \n" +
