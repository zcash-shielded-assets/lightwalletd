...
type CompactTx struct {
	...
	// ZSA issuance actions (ZIP-227) present in V6+ transactions.
	Issuances     []*CompactIssuance `protobuf:"bytes,9,rep,name=issuances,proto3" json:"issuances,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CompactTx) GetIssuances() []*CompactIssuance {
	if x != nil {
		return x.Issuances
	}
	return nil
...
type CompactOrchardAction struct {
	...
	Ciphertext    []byte                 `protobuf:"bytes,4,opt,name=ciphertext,proto3" json:"ciphertext,omitempty"`     // [52 or 84] Compact portion of the encCiphertext field (52 bytes for v5, 84 bytes for v6/ZSA)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// within an IssueAction. Since issuance notes are transmitted as plaintext
// in the V6 Issue bundle, the wallet can synthesize them without decryption.
type CompactIssueNote struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Recipient     []byte                 `protobuf:"bytes,1,opt,name=recipient,proto3" json:"recipient,omitempty"` // 43 bytes — recipient address encoding (diversifier + pk_d)
	Value         uint64                 `protobuf:"varint,2,opt,name=value,proto3" json:"value,omitempty"`        // Note value in asset base units
	Rho           []byte                 `protobuf:"bytes,3,opt,name=rho,proto3" json:"rho,omitempty"`             // [32] Nullifier derivation base
	Rseed         []byte                 `protobuf:"bytes,4,opt,name=rseed,proto3" json:"rseed,omitempty"`         // [32] Random seed
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CompactIssueNote) Reset() {
	*x = CompactIssueNote{}
	mi := &file_compact_formats_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompactIssueNote) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompactIssueNote) ProtoMessage() {}

func (x *CompactIssueNote) ProtoReflect() protoreflect.Message {
	mi := &file_compact_formats_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompactIssueNote.ProtoReflect.Descriptor instead.
func (*CompactIssueNote) Descriptor() ([]byte, []int) {
	return file_compact_formats_proto_rawDescGZIP(), []int{8}
}

func (x *CompactIssueNote) GetRecipient() []byte {
	if x != nil {
		return x.Recipient
	}
	return nil
...
func (x *CompactIssueNote) GetValue() uint64 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *CompactIssueNote) GetRho() []byte {
	if x != nil {
		return x.Rho
	}
	return nil
...
func (x *CompactIssueNote) GetRseed() []byte {
	if x != nil {
		return x.Rseed
	}
	return nil
...
type CompactIssuance struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AssetDescHash []byte                 `protobuf:"bytes,1,opt,name=assetDescHash,proto3" json:"assetDescHash,omitempty"` // [32] BLAKE2b-256 hash of the asset description string
	Finalize      bool                   `protobuf:"varint,2,opt,name=finalize,proto3" json:"finalize,omitempty"`          // Whether this action finalizes the asset
	Ik            []byte                 `protobuf:"bytes,3,opt,name=ik,proto3" json:"ik,omitempty"`                       // [33] Issuer Validating Key (algorithm byte + x-only pubkey)
	IssuedAmount  uint64                 `protobuf:"varint,4,opt,name=issuedAmount,proto3" json:"issuedAmount,omitempty"`  // Sum of all note values in this IssueAction (in asset base units)
	Notes         []*CompactIssueNote    `protobuf:"bytes,5,rep,name=notes,proto3" json:"notes,omitempty"`                 // Per-note unencrypted data
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CompactIssuance) Reset() {
	*x = CompactIssuance{}
	mi := &file_compact_formats_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompactIssuance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompactIssuance) ProtoMessage() {}

func (x *CompactIssuance) ProtoReflect() protoreflect.Message {
	mi := &file_compact_formats_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompactIssuance.ProtoReflect.Descriptor instead.
func (*CompactIssuance) Descriptor() ([]byte, []int) {
	return file_compact_formats_proto_rawDescGZIP(), []int{9}
}

func (x *CompactIssuance) GetAssetDescHash() []byte {
	if x != nil {
		return x.AssetDescHash
	}
	return nil
}

func (x *CompactIssuance) GetFinalize() bool {
	if x != nil {
		return x.Finalize
	}
	return false
...
func (x *CompactIssuance) GetIk() []byte {
	if x != nil {
		return x.Ik
	}
	return nil
...
func (x *CompactIssuance) GetIssuedAmount() uint64 {
	if x != nil {
...
func (x *CompactIssuance) GetNotes() []*CompactIssueNote {
	if x != nil {
		return x.Notes
	}
	return nil
...
const file_compact_formats_proto_rawDesc = "" +
	...
	"\rchainMetadata\x18\b \x01(\v2$.cash.z.wallet.sdk.rpc.ChainMetadataR\rchainMetadata\"\xc7\x03\n" +
	"\tCompactTx\x12\x14\n" +
	...
	"\x04vout\x18\b \x03(\v2\x1c.cash.z.wallet.sdk.rpc.TxOutR\x04vout\x12D\n" +
	"\tissuances\x18\t \x03(\v2&.cash.z.wallet.sdk.rpc.CompactIssuanceR\tissuances\"S\n" +
	"\vCompactTxIn\x12 \n" +
	...
	"ciphertext\"n\n" +
	"\x10CompactIssueNote\x12\x1c\n" +
	"\trecipient\x18\x01 \x01(\fR\trecipient\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x04R\x05value\x12\x10\n" +
	"\x03rho\x18\x03 \x01(\fR\x03rho\x12\x14\n" +
	"\x05rseed\x18\x04 \x01(\fR\x05rseed\"\xc6\x01\n" +
	"\x0fCompactIssuance\x12$\n" +
	"\rassetDescHash\x18\x01 \x01(\fR\rassetDescHash\x12\x1a\n" +
	"\bfinalize\x18\x02 \x01(\bR\bfinalize\x12\x0e\n" +
	"\x02ik\x18\x03 \x01(\fR\x02ik\x12\"\n" +
	"\fissuedAmount\x18\x04 \x01(\x04R\fissuedAmount\x12=\n" +
	"\x05notes\x18\x05 \x03(\v2'.cash.z.wallet.sdk.rpc.CompactIssueNoteR\x05notesB\x1bZ\x16lightwalletd/walletrpc\xba\x02\x00b\x06proto3"
...
var file_compact_formats_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_compact_formats_proto_goTypes = []any{
	...
	(*CompactIssueNote)(nil),     // 8: cash.z.wallet.sdk.rpc.CompactIssueNote
	(*CompactIssuance)(nil),      // 9: cash.z.wallet.sdk.rpc.CompactIssuance
}
var file_compact_formats_proto_depIdxs = []int32{
	...
	9, // 7: cash.z.wallet.sdk.rpc.CompactTx.issuances:type_name -> cash.z.wallet.sdk.rpc.CompactIssuance
	8, // 8: cash.z.wallet.sdk.rpc.CompactIssuance.notes:type_name -> cash.z.wallet.sdk.rpc.CompactIssueNote
